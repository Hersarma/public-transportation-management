                ...
                <div class="space-y-6 sm:space-y-5">
                  ...
                  <div class="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                      ...
                      <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <div class="flex items-center">
                          <input readonly type="text" name="trafficLicenseExpirationDate" id="trafficLicenseExpirationDate" autocomplete="trafficLicenseExpirationDate" value="{{$vehicle->trafficLicenseExpirationDate->format('d-m-Y')}}" placeholder="Izaberi datum" class="datepicker max-w-lg block py-4 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md">
                          <div class="px-3 py-2 -ml-10">
                            <svg
                              class="h-6 w-6 text-gray-400"
                              fill="none"
