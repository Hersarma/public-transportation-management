...
<div class="px-4 sm:px-6 lg:px-8">
  <div class="flex items-center justify-between">
    ...
    <div
      ...
      <button @click="open = true" type="button" class="inline-flex items-center justify-center rounded-md border border-transparent bg-gray-700 px-4 py-2 text-sm font-medium text-yellow-400 shadow-sm hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 sm:w-auto">Dodaj vozilo<span class="ml-2">
  ...
  <div x-data="{open: false}">
    <div class="searchVehicle -mx-4 mt-8 overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:-mx-6 md:mx-0 md:rounded-lg">
      @include('admin.vehicles.searchVehicle')
