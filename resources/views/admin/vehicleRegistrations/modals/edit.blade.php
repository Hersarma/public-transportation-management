          ...
          <form method="POST" action="{{ route('vehicleRegistrations.update', $vehicleRegistration) }}" enctype="multipart/form-data" class="space-y-8 divide-y divide-gray-200 bg-white lg:px-8 px-2 py-4 rounded-lg">
            ...
            <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
              <div class="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
                <div>
                  <h3 class="text-lg leading-6 font-medium text-gray-900">Izmeni Registraciju</h3>
                </div>
                  ...
                  <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                      ...
                      <p class="text-red-500 text-sm italic mt-4">
                        {{ $errors->edit_vehicle_registration->first('purchase_date') }}
                      </p>
                    </div>
                  </div>
                  <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                      <input readonly type="text" name="expirationDate" id="expirationDate" autocomplete="expirationDate" value="{{ $vehicleRegistration->expirationDate->format('d-m-Y') }}" class="datepicker max-w-lg block py-4 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md">
                      <p class="text-red-500 text-sm italic mt-4">
                        {{ $errors->edit_vehicle_registration->first('expirationDate') }}
                      </p>
                    </div>
                  </div>
                  <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
