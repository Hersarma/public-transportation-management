<table class="min-w-full divide-y divide-gray-300 mb-10 lg:mb-0">
      <thead class="bg-gray-50">
        <tr>
          ...
          <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell">Registracija</th>
          <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 sm:table-cell">Datum registracije</th>
          <th scope="col" class="py-3.5 text-left text-sm font-semibold text-gray-900 sm:table-cell">Registrovan do</th>
          <th scope="col" class="hidden py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6 sm:table-cell">Cena</th>
      ...
      <tbody class="divide-y divide-gray-200 bg-white">
        ...
        <tr>
          ...
          <td class="hidden px-3 py-4 text-sm text-gray-500 sm:table-cell">{{ $vehicleRegistration->price }} din.</td>
