<table class="min-w-full divide-y divide-gray-300 mb-10 lg:mb-0">
      ...
      <tbody class="searchVehicle divide-y divide-gray-200 bg-white">
        ...
        <tr>
          ...
          <td class="hidden px-3 py-4 text-sm text-gray-500 sm:table-cell">{{ $vignette->purchase_date }}</td>
          <td class="px-3 py-4 text-sm text-gray-500">{{ $vignette->expirationDate }}</td>
